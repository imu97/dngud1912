...
public class APIView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("8. Date Class");
...
//		System.out.println(s2.hashCode());
	...
	private void ex5() {
		...
		System.out.println(sb.length()); // 글자 수
	...
	private void ex7() {
		...
		double d = Double.parseDouble("3.148796542") + 10.0;
		...
		/* Boxing / Unboxing
		 * Boxing : 기본 자료형을 -> Wrapper Class 객체
	...
	private void ex8() {
		...
		// SimpleDateFormat : 간단한 날짜 형식을 지정하는 객체
		// java.text 패키지에서 제공
