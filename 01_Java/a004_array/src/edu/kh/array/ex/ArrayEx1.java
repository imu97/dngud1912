...
public class ArrayEx1 {
	...
	public void ex1() {
		...
		// 배열 선언
		int[] arr;
		// - int 배열을 참조할 공간을 할당하고 이를 arr 이라고 부르겠다.
...
//		String[] menuArr = new String[10];
		String[] menuArr = {"김밥 + 라면", "서브웨이", "KFC", "맘스터치", "순대국", 
							"뼈해장국", "닭갈비", "마라탕", "우육면", "파스타"};
	...
	public void ex5() {
		...
		//			증가하도록 작성되어
		//			실행 시 for문 내 출력 구문에서 
		//			ArrayIndexOutOfBoundsException이 발샐함.
