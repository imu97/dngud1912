...
public class ListService {
	 ...
	 * 
	 * - 인덱스를 이용해서 순서를 유지 - 순서 구분이 가능하기 때문에 중복되는 데이터를 저장할 수 있다.
	 * 
	 * List 인터페이스로 구현한 대표적인 클래스 -> ArrayList, Vector, linkedList
	 */

	public void ex1() {

		/*
		 * 컬렉션 특징 1) 크기 제약이 없다 2) 추가, 삭제, 수정 등의 기능이 구현되어있다. 3) 여러 타입의 객체를 저장할 수 있다. ->
